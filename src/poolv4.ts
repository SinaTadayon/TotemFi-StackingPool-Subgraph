...
import { StakingPoolV5 as StakingPoolContract } from "../generated/templates"
import { PoolCreated } from "../generated/StakingPoolFactoryV5/StakingPoolFactoryV5"
import {
    Stake as StakeEvent,
...
} from "../generated/templates/StakingPoolV5/StakingPoolV5"
...
export function handleWithdraw(event: WithdrawEvent): void {
    ...
    entity.user = event.params.user.toHex()
    entity.value = event.params.amount
    entity.btcValue = event.params.wrappedTokenAmount
    entity.timestamp = event.block.timestamp
    entity.save()
    ...
    pool.totalWithdrawedToken = pool.totalWithdrawedToken!.plus(event.params.wrappedTokenAmount)
    pool.save()
